...
class TestCollectQuestion(unittest.TestCase):
    ...
    def test_request_question_found(self):
        ...
        self.assertEquals("Texte de la question", self.collect_question_command.request_question())
    ...
    def test_request_question_not_found(self):
        ...
        self.assertRaises(request_exceptions.WrongStatusCodeException, lambda: self.collect_question_command.request_question())
    ...
    def test_request_question_but_no_question(self):
        ...
        self.assertRaises(request_exceptions.NoContentException, lambda: self.collect_question_command.request_question())
